...
parseArguments(int argc, char **argv, parsedArguments &pA, ros::NodeHandle &nh)
{
 ...
 // {
      if (nh.getParam("nonplanar_segmentation/v", val))
      {
          pA.hue_val = val;
      }
      if (nh.getParam("nonplanar_segmentation/t", val))
      {
          pA.hue_thresh = val;
      }
      if (nh.getParam("nonplanar_segmentation/z", val))
      {
          pA.z_thresh = val;
      }
      if (nh.getParam("nonplanar_segmentation/e", val))
      {
          pA.euc_thresh = val;
      }
      if (nh.getParam("nonplanar_segmentation/p", bVal))
      {
          pA.pre_proc = bVal;
      }
      if (nh.getParam("nonplanar_segmentation/c", iVal))
      {
          pA.seg_color_ind = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/m", bVal))
      {
          pA.merge_clusters = bVal;
      }
      if (nh.getParam("nonplanar_segmentation/dt", val))
      {
          pA.ecc_dist_thresh = val;
      }
      if (nh.getParam("nonplanar_segmentation/ct", val))
      {
          pA.ecc_color_thresh = val;
      }
      if (nh.getParam("nonplanar_segmentation/src", iVal))
      {
    	  pA.pc_source = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/out", iVal))
      {
          pA.output_type = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/comm", iVal))
      {
    	  pA.comm_medium = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/rt", sVal))
      {
          sprintf(pA.ros_topic, "%s", sVal.c_str());
      }
      if (nh.getParam("nonplanar_segmentation/b", iVal))
      {
          pA.displayAllBb = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/sh", iVal))
      {
          pA.saturation_hack = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/st", val))
      {
          pA.saturation_hack_value = val;
      }
      if (nh.getParam("nonplanar_segmentation/sv", val))
      {
          pA.saturation_mapped_value = val;
      }
      if (nh.getParam("nonplanar_segmentation/ri", iVal))
      {
          pA.robot_id = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/pr", iVal))
      {
    	  pA.freenectProcessor = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/fn", iVal))
      {
    	  pA.filterNoise = iVal;
      }
      if (nh.getParam("nonplanar_segmentation/nv", bVal))
      {
    	  pA.viz = !bVal;
      }
      if (nh.getParam("nonplanar_segmentation/view", iVal))
      {
    	  pA.justViewPointCloud = iVal; 
      }
      if (nh.getParam("nonplanar_segmentation/h", bVal))
      {
